...
<p>Before posting please do a search on Xoops.org using the site's <a href="http://xoops.org/search.php" target="_blank">Search feature</a> with appropriate "keywords" and find out if the subject has been dealt with before. Also look through the <a href="http://xoops.org/modules/smartfaq/"
...
<p><b>Turn on debug:</b><br>
    To switch on debug, go to system admin-->preferences and then general settings. You will see a "Debug mode" field. Choose "PHP Debug". Then go to the page that has problems and copy and paste any error messages under php-debug messages in the template below. Do this for each debug type (PHP,
    MySQL, Smarty). <br>
    <br>
