...
<p>Le meilleur moyen de faire votre demande est d'utiliser un titre clair, et d'expliquer votre probl�me avec le maximum de d�tails en respectant la chonologie. Si vous avez des soucis avec un th�me ou un module, indiquez pr�cis�ment leur nom et leur
    version.</p>
...
<p>S�lectionner l'une des valeurs dans le champ "Mode de mise au point", en principe <em>Mise au point php</em>sera celle que vous utiliserez en premier. Vous pouvez faire un copier/coller des messages d'erreur dans votre message sur le forum si vous
    ne comprenez pas leur signification.</p>
...
<p>Attention : l'activation de ce mode s'affiche dans une fen�tre popup visible par tous les visiteurs de votre site. Si vous ne voyez pas cette fen�tre, v�rifiez qu'un logiciel anti-popup ou votre naivgateur ne bloque pas l'ouverture de cette
    fen�tre.</p>
